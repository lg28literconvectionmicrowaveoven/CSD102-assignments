...
int main() {
    ...
    arr[target_index].id = 20;
    arr[target_index].sub1_marks = randint(0, 100);
    arr[target_index].sub2_marks = randint(0, 100);
    arr[target_index].sub3_marks = randint(0, 100);
    arr[target_index].sub4_marks = randint(0, 100);
    arr[target_index].sub5_marks = randint(0, 100);
